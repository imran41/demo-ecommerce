...
export default function SignupPage() {
  ...
  const { signup, user, showToast } = useStore();
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 px-4 py-12 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md bg-white/10 backdrop-blur-md border border-white/10 rounded-3xl p-8 shadow-2xl space-y-6 text-white">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xxs text-slate-350 font-medium">Join us to shop customizable keyboards, smartwatches and headphones.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label htmlFor="name-input" className="text-[10px] font-bold text-slate-300 uppercase tracking-wider">Full Name</label>
          ...
          {/* Phone */}
          <div className="space-y-1.5">
            <label htmlFor="phone-input" className="text-[10px] font-bold text-slate-300 uppercase tracking-wider">Phone number</label>
            <div className="relative">
              <input
                id="phone-input"
                name="phone"
          ...
          {/* Confirm Password */}
          <div className="space-y-1.5">
            <label htmlFor="confirm-password-input" className="text-[10px] font-bold text-slate-300 uppercase tracking-wider">Confirm Password</label>
            <div className="relative">
              <input

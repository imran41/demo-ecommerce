...
import { Mail, Lock, LogIn, Chrome, ArrowRight, HelpCircle } from 'lucide-react';
...
function LoginPageContent() {
  ...
  const { login, signup, user, authLoading, showToast } = useStore();
  ...
  const handleGoogleLogin = async () => {
    setLoading(true);
    try {
      // Import the oauth flow from authService
